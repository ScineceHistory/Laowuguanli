 ...
 * 数据访问接口的实现类
 */
public class LoaderDaoImplWorkQ implements LoaderDaoWork {
    private SaveUserWorkInfoHelperQ helper;

    public LoaderDaoImplWorkQ(Context mContext) {
        helper = new SaveUserWorkInfoHelperQ(mContext);
    }
