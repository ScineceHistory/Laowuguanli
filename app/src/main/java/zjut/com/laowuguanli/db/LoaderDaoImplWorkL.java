 ...
 * 数据访问接口的实现类
 */
public class LoaderDaoImplWorkL implements LoaderDaoWork {
    private SaveUserWorkInfoHelperL helper;

    public LoaderDaoImplWorkL(Context mContext) {
        helper = new SaveUserWorkInfoHelperL(mContext);
    }
